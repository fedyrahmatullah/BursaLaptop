package com.example.imor.brs_laptop.adapter;
...
public class GridAdapter1 extends RecyclerView.Adapter<GridAdapter1.ViewHolder> {
    ...
    public GridAdapter1() {
        ...
        nama.setThumbnail(R.drawable.komputer);
        mItems.add(nama);

        nama = new EndangeredItem();
        nama.setName("Surat Al-Maidah Ayat 1-10");
        nama.setThumbnail(R.drawable.account);
        mItems.add(nama);

        nama = new EndangeredItem();
        nama.setName("Surat Al-Baqoroh Ayat 1-10");
        nama.setThumbnail(R.drawable.account1);
        mItems.add(nama);
        ...
        nama = new EndangeredItem();
        nama.setName("Surat Al-Maidah Ayat 1-10");
        nama.setThumbnail(R.drawable.keranjang);
        mItems.add(nama);

        nama = new EndangeredItem();
        nama.setName("Surat Al-Baqoroh Ayat 1-10");
        nama.setThumbnail(R.drawable.keyboard);
        mItems.add(nama);
